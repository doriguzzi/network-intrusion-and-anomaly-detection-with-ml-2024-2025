...
def main(argv):
    ...
    parser.add_argument('--multiclass', help='Multiclass labels', action='store_true')
    ...
    if args.preprocess_folder is not None or args.preprocess_file is not None:
        ...
        mins,maxs = static_min_max(time_window=time_window,max_flow_len=max_flow_len) # static mins and maxs
